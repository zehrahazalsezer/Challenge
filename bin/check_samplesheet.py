        ...
        **kwargs,
        ...
        Args:
            ...
            second_col (str): The name of the column that contains the second (if any)
                INDEX file path (default "index").
            single_col (str): The name of the column that contains the file types
                (default "file_type").
...
def check_samplesheet(file_in, file_out):
    ...
    an additional column which records whether one or two BAM were found.
    ...
    """
    required_columns = {"sample", "bam", "file_type"}
